...
inputRef.current.value = ''
    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 realative'>
            <div className='text-center mt-20 mb-8'>
                ...
                <p className='text-gray-500 my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs'>This is your space to think out loud, to share what matters,
